...
class AllArticleTab extends ConsumerStatefulWidget {
  const AllArticleTab({super.key});
  @override
  ConsumerState<AllArticleTab> createState() => _AllArticleTabState();
}

class _AllArticleTabState extends ConsumerState<AllArticleTab> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    print('progress from the screen is $progress');
    return state.when(
        data: (articles) => ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ArticleTile(
                ...
                isStarred: articles[index].starred,
